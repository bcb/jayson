...
Server.errorMessages[Server.errors.INVALID_PARAMS] = 'Invalid params';
Server.errorMessages[Server.errors.INTERNAL_ERROR] = 'Internal error';


Server.invalidParams = function(data) {
  return Server.prototype.error(Server.errors.INVALID_PARAMS,
      Server.errorMessages[Server.errors.INVALID_PARAMS], data)
}

Server.internalError = function(data) {
  return Server.prototype.error(Server.errors.INTERNAL_ERROR,
      Server.errorMessages[Server.errors.INTERNAL_ERROR], data)
}
